...
For example, for the given binary tree (1, 2, 3, 4, 5, 6, 7) in Figure 2, the maximum height is 2.
    */
    ...
    // Height of the tree is the maximum of the heights of its left and right subtrees, plus 1 for the current node
